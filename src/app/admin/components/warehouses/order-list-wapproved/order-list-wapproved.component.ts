...
@Component({
  selector: 'app-order-list-wapproved',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './order-list-wapproved.component.html',
  styleUrl: './order-list-wapproved.component.scss'
})
export class OrderListWapprovedComponent implements AfterViewInit, OnInit {
  ...
  getOrders() {
    try {
      this.sOrder.approveds().subscribe({
        next: (resp: any) => {
