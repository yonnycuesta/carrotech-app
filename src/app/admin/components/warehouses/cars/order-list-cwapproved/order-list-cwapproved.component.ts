...
@Component({
  selector: 'app-order-list-cwapproved',
  standalone: true,
  imports: [
    CommonModule,
    MatTabsModule,
  ...
  templateUrl: './order-list-cwapproved.component.html',
  styleUrl: './order-list-cwapproved.component.scss'
})
export class OrderListCwapprovedComponent implements OnInit, AfterViewInit {
  ...
  private loadWarehouseData(warehouseId: string | number): void {
    ...
    this.sOrder.indexCarApproved(warehouseId)
      .pipe(
