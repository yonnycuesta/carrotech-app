...
import { NewItemFormModalComponent } from './new-item-form-modal/new-item-form-modal.component';
...
@Component({
  selector: 'app-order-car-approved',
  standalone: true,
  imports: [
    CommonModule,
    MatDialogModule,
  ...
  templateUrl: './order-car-approved.component.html',
  styleUrl: './order-car-approved.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class OrderCarApprovedComponent implements OnInit, OnDestroy, AfterViewInit {
