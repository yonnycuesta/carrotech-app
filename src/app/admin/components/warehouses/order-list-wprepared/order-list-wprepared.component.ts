...
@Component({
  selector: 'app-order-list-wprepared',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './order-list-wprepared.component.html',
  styleUrl: './order-list-wprepared.component.scss'
})
export class OrderListWpreparedComponent implements AfterViewInit, OnInit {
  ...
  getOrders() {
    try {
      this.sOrder.prepareds().subscribe({
        next: (resp: any) => {
