...
@Component({
  selector: 'app-order-staff-completed',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './order-staff-completed.component.html',
  styleUrl: './order-staff-completed.component.scss'
})
export class OrderStaffCompletedComponent implements AfterViewInit, OnInit {
  ...
  getOrders() {
    try {
      this.sOrder.completedStaff(this.managerId).subscribe({
        next: (resp: any) => {
