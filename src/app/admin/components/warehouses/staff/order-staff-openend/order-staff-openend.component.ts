...
@Component({
  selector: 'app-order-staff-openend',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './order-staff-openend.component.html',
  styleUrl: './order-staff-openend.component.scss'
})
export class OrderStaffOpenendComponent implements AfterViewInit, OnInit {
  ...
  getOrders() {
    try {
      this.sOrder.openendStaff(this.managerId).subscribe({
        next: (resp: any) => {
